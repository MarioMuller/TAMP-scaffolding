...
coll1(shoulder_pan_joint_origin)  { shape:capsule color:[1.,1.,1.,.5] size:[.07 .08] Q:"t(0 0.05 0.0) d(90 90 1 0)", contact:-2 }
...
coll4(elbow_joint)                { shape:capsule color:[1.,1.,1.,.5] size:[.37 .052] Q:"t(0 .2 -.07) d(90 90 1 0)", contact:-2 }
...
coll7(wrist_3_joint)              { shape:capsule color:[1.,1.,1.,.5] size:[.1 .05] Q:"t(0 0 -.015) d(0 0 1 0)", contact:-2 }
